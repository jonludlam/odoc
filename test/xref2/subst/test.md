...
# compile {|
  ...
  |} ;;
- : Component.Signature.t =
module type Monad_2/102 ...
module SwappedVars/101 = : sig
  type t/103 ...
  include : r(Monad_2/102) with [r(root(Monad_2/102).t) = [b * a] r(t/103)] (sig =
    val map/104 ...
    val join/105 ...
    val both/106 ...
     (removed=[]))
...
module M/124 = : sig
  type t/126 ...
  include : r(S/125) with [r(root(S/125).t) = [(alias (poly_var [ `A of (a * b) ]) b)] r(t/126)] (sig =
    val map/127 ...
     (removed=[]))
   (removed=[])end
 (removed=[])
