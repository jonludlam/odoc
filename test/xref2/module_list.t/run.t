...
Everything should resolve:
  ...
  {"`Resolved":{"`Alias":[{"v":{"`Module":[{"v":{"`Identifier":{"`Root":[{"Some":{"`Page":["None","test"]}},"External"]}},"key":["73","main.cmti"]},"X"]},"key":["176","main.odoc"]},{"`Identifier":{"`Module":[{"`Root":[{"Some":{"`Page":["None","test"]}},"Main"]},"Alias"]}}]}}
  "None"
  {"`Resolved":{"`Alias":[{"v":{"`Canonical":[{"v":{"`Module":[{"v":{"`Identifier":{"`Module":[{"`Root":[{"Some":{"`Page":["None","test"]}},"Main"]},"Internal"]}},"key":["85","main.cmti"]},"C1"]},"key":["109","main.odoc"]},{"v":{"`Resolved":{"v":{"`Identifier":{"`Module":[{"`Root":[{"Some":{"`Page":["None","test"]}},"Main"]},"C1"]}},"key":["81","main.odoc"]}},"key":["106","main.odoc"]}]},"key":["110","main.odoc"]},{"`Identifier":{"`Module":[{"`Root":[{"Some":{"`Page":["None","test"]}},"Main"]},"C1"]}}]}}
  "None"
  {"`Resolved":{"`Alias":[{"v":{"`Canonical":[{"v":{"`Module":[{"v":{"`Identifier":{"`Module":[{"`Root":[{"Some":{"`Page":["None","test"]}},"Main"]},"Internal"]}},"key":["85","main.cmti"]},"C2"]},"key":["129","main.odoc"]},{"v":{"`Resolved":{"v":{"`Identifier":{"`Module":[{"`Root":[{"Some":{"`Page":["None","test"]}},"Main"]},"C2"]}},"key":["118","main.odoc"]}},"key":["126","main.odoc"]}]},"key":["130","main.odoc"]},{"`Identifier":{"`Module":[{"`Root":[{"Some":{"`Page":["None","test"]}},"Main"]},"C2"]}}]}}
  "None"
