...
Every references should be marked as canonical:
  ...
  {"`Resolved":["990593190",{"`Canonical":[{"`Root":"Test_x"},{"`Resolved":["861748510",{"`Identifier":{"`Module":[{"`Root":[{"Some":{"`Page":["None","test"]}},"Test"]},"X"]}}]}]}]}
  {"`Resolved":["355812365",{"`Canonical":[{"`Dot":[{"`Root":"Test_x"},"Out"]},{"`Resolved":["871725559",{"`Identifier":{"`Module":[{"`Root":[{"Some":{"`Page":["None","test"]}},"Test"]},"X_out"]}}]}]}]}
  {"`Resolved":["231918107",{"`Canonical":[{"`Dot":[{"`Root":"Test_x"},"In"]},{"`Resolved":["879086977",{"`Identifier":{"`Module":[{"`Root":[{"Some":{"`Page":["None","test"]}},"Test"]},"X_in"]}}]}]}]}
  {"`Resolved":["586813011",{"`Canonical":[{"`Root":"Test_y"},{"`Resolved":["553889793",{"`Identifier":{"`Module":[{"`Root":[{"Some":{"`Page":["None","test"]}},"Test"]},"Y"]}}]}]}]}
  {"`Resolved":["834951223",{"`Canonical":[{"`Dot":[{"`Root":"Test_y"},"Out"]},{"`Resolved":["811235783",{"`Identifier":{"`Module":[{"`Root":[{"Some":{"`Page":["None","test"]}},"Test"]},"Y_out"]}}]}]}]}
  {"`Resolved":["806404221",{"`Canonical":[{"`Dot":[{"`Root":"Test_y"},"In"]},{"`Resolved":["153439974",{"`Identifier":{"`Module":[{"`Root":[{"Some":{"`Page":["None","test"]}},"Test"]},"Y_in"]}}]}]}]}
