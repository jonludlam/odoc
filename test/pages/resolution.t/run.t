...
This is the '{!childpage-sub1}' reference
  $ odoc_print page-top1.odocl | jq '.content.docs[1]["`Paragraph"][0]["`Reference"][0]'
  {
    "`Resolved": {
      "`Identifier": {
        "`Page": [
...
This is the '{!childpage:sub2}' reference
  $ odoc_print page-top1.odocl | jq '.content.docs[1]["`Paragraph"][2]["`Reference"][0]'
  {
    "`Resolved": {
      "`Identifier": {
        "`Page": [
...
This is the '{!childmodule:M1}' reference
  $ odoc_print page-sub1.odocl | jq '.content.docs[1]["`Paragraph"][0]["`Reference"][0]'
  {
    "`Resolved": {
      "`Identifier": {
        "`Root": [
