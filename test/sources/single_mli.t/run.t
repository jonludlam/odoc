...
`A.X` and `A.X.Y` should contain a link to `A_x.ml.html`:
  ...
  $ grep source_link -C1 html/A/X/Y/index.html
     <h1>Module <code><span>X.Y</span></code>
      <a href="../../../root/source/a_x.ml.html#module-Y" class="source_link">
       Source
  --
       <a href="../../../root/source/a_x.ml.html#module-Y.value-z"
        class="source_link">Source
       </a><code><span><span class="keyword">val</span> z : int</span></code>
