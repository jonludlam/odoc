\section{Module \inlinecode{Section}}\label{page-test+u+package+++ml-module-Section}%
...
\label{page-test+u+package+++ml-module-Section-val-foo}\codefragment{\begin{keyword}val\end{keyword}
 foo : unit}\\
\subsection{Empty section\label{empty-section}}%
...
\subsection{\emph{This} \inlinecode{section} \textbf{title} \textsubscript{has} \textsuperscript{markup}\label{this-section-title-has-markup}}%
