...
[""; "'../src/odoc/bin/main.exe' 'link' 'page-deps.odoc' '-I' '.'";
 ...
 "page-yojson.odoc: File \"library_mlds/yojson.mld\", line 4, characters 0-23:";
 "page-yojson.odoc: Warning: Failed to resolve reference unresolvedroot(Yojson_biniou) Parent_module: Lookup failure (root module): Yojson_biniou"]
# !source_tree_output;;
- : string list = [""]
# !generate_output;;
- : string list =
...
html/odoc/deps/tyxml/Xml_wrap/module-type-NoWrap/index.html
html/odoc/deps/tyxml/Xml_wrap/module-type-T
...
'../src/odoc/bin/main.exe' 'compile' 'library_mlds/yojson.mld' '-I' '.' '-o' './page-yojson.odoc' '--child' 'module-Yojson' '--parent' 'page-"deps"'
