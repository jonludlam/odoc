...
val extract_structure_tree_items : bool -> Typedtree.structure_item list -> items list 

val extract_signature_tree_items : bool -> Typedtree.signature_item list -> items list

val identifier_of_loc : t -> Warnings.loc -> Odoc_model.Paths.Identifier.t option