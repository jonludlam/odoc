...
let%expect_test _ =
  with_group "plus_minus_bar_words" @@ fun () ->
...
let%expect_test _ =
  with_group "escape_sequence" @@ fun () ->
...
let%expect_test _ =
  with_group "reference_with_text" @@ fun () ->
...
let%expect_test _ =
  with_group "comment_location" @@ fun () ->
...
let%expect_test _ =
  ...
  let module Locations = struct
    ...
    let test
      ...
      let body = Buffer.contents buf in
      print_string body;
      dump_block ~input:text ~output:body
