...
module ModuleType = struct
  let rec doc : Component.ModuleType.t Component.Delayed.t ->
    Component.CComment.docs =
    function
    | Val x -> x.doc
    ...
    let rec canonical : Component.ModuleType.t Component.Delayed.t ->
      Odoc_model.Paths.Path.ModuleType.t option =
     function
