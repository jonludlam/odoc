...
val add_type : Identifier.Type.t -> Component.TypeDecl.t Component.Delayed.t -> t -> t

val add_module_type :
  Identifier.Path.ModuleType.t -> Component.ModuleType.t Component.Delayed.t -> t -> t

val update_module_type :
  Identifier.Path.ModuleType.t -> Component.ModuleType.t Component.Delayed.t -> t -> t

val add_value : Identifier.Value.t -> Component.Value.t Component.Delayed.t -> t -> t
